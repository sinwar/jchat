...
# asgi server is used as interface server
# another way is inmemory which provides no cross process channel transportation
CHANNEL_LAYERS = {
    "default": {
...
STATIC_ROOT = os.path.join(BASE_DIR, "pr")
STATIC_URL = '/static/'
STATICFILES_DIRS = [
